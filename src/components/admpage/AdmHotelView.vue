  ...
  <div class="">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-copy"></i>风景配置</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
  ...
  export default {
    ...
    methods: {
      ...
      var formdata = new FormData(); // 创建form对象
        ...
        this.$axios
          .post("/api/hoInView/uploadViewPic", formdata)
          .then(res => {
      ...
      deleteImgPic(item, index) {
        ...
        this.$axios
          .post("/api/hoInView/deleteViewPic", data)
          .then(res => {
            console.log(res.data);
            if (res.data.code == 0) {
              this.datas_upload.splice(index, 1);
      ...
      getImgPic(viewId) {
        this.datas_upload=[]
        this.$axios
          .get("/api/hoInView/getViewPic/" +viewId)
          .then(res => {
            console.log(res.data);
      ...
      upSubmit() {
        ...
        this.$axios
          .post("/api/hoInView/updateView", data)
          .then(res => {
            if (res.data.code == 0) {
      ...
      handleDelete(index, row) {
        ...
        this.$axios
          .post("/api/hoInView/deleteView", data)
          .then(res => {
            console.log(res.data);
            this.getView();
          }).catch((err) => {
      ...
      getView() {
        this.tableData=[]
        this.$axios
          .get("/api/hoInView/getView")
          .then(res => {
            console.log(res.data);
            for (var i = 0; i < res.data.data.length; i++) {
              this.tableData.push({
                viewId: res.data.data[i].id,
                name: res.data.data[i].viewName,
