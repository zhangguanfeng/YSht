  ...
  <div class="">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-copy"></i>关于配置</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
    ...
    methods: {
      ...
      uploadImgPic() {
        if (limitImg(this.imgFile)) {
          ...
          this.$axios
            .post("/api/hoInAbout/uploadPic", formdata)
            .then(res => {
      ...
      deleteImgPic(item, index) {
        ...
        this.$axios
          .post("/api/hoInAbout/deletePic", data)
          .then(res => {
            console.log(res.data);
            if (res.data.code == 0) {
              this.datas_upload.splice(index, 1);
      ...
      onSubmit() {
        ...
        this.$axios
          .post("/api/hoInAbout/subCheck", data)
          .then(res => {
            if (res.data.code == 0) {
